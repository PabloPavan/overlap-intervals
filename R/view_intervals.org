...
:  $ filename  : Factor w/ 3 levels "11.parsed.json",..: 1 1 2 2 3 3
:  $ start_time: int  3761 3761 3761 3761 3761 3761
:  $ end_time  : int  4508 4508 4508 4508 4508 4508
:  $ start     : num  2.3 2.3 5 5 8 32
:  $ end       : num  49.8 49.8 40 40 30 45
:  $ info      : Factor w/ 5 levels "posix read file",..: 3 4 5 2 1 1
...
'data.frame':	6 obs. of  9 variables:
 ...
 $ duration  : num  47.5 47.5 35 35 22 13
...
str(df)
 ...
 :  $ start   : int  3763 3766 3769 3791 3793 3801 3806
 :  $ end     : int  3766 3769 3791 3793 3801 3806 3810
 :  $ duration: int  3 3 22 2 8 5 4
 :  $ phases  : Factor w/ 5 levels "0,1","0,1,2,3",..: 1 2 3 2 4 5 1
 :  $ nphases : int  2 4 5 4 5 3 2
 :  $ jobs    : Factor w/ 4 levels "0","0,1","0,1,2",..: 1 2 3 2 3 4 1
 :  $ njobs   : int  1 2 3 2 3 2 1
